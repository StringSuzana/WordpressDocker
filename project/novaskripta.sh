...
sudo chown root:root ./prod/wp_data/html/wp-admin/install.php
echo "This is a production site: ${APP}" > ./prod/wp_data/html/wp-admin/install.php
sudo chown www-data:www-data ./prod/wp_data/html/wp-admin/install.php
...
sudo chown root:root ./test/wp_data/html/wp-admin/install.php
echo "This is a test site ${APP}" > ./test/wp_data/html/wp-admin/install.php
sudo chown www-data:www-data ./test/wp_data/html/wp-admin/install.php
fi
